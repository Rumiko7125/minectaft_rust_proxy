import{d as ee,C as c,r as L,aB as ut,aC as vt,aD as Z,aE as ht,I as gt,Q as xt,U as Pe,ar as mt,P as yt,M as wt,aF as St,as as Ct,p as Q,aG as Rt,s as r,v as i,x as m,y as T,A as Tt,D as ne,K as ye,aa as oe,E as $t,G as We,ae as ie,o as zt,ac as Pt,R as Wt,aH as Et,Y as _t,aI as At,aJ as Lt,aK as Bt,a6 as se,W as j,ay as J,Z as kt,J as jt,V as I,X as q}from"./index-DQgClpag.js";import{A as It}from"./Add-C00RkFDM.js";import{c as Ht,a as we,u as Ot,o as Ft,b as Se}from"./Popover-BT2YCJ3w.js";const Dt=we(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[we("&::-webkit-scrollbar",{width:0,height:0})]),Mt=ee({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=L(null);function n(d){!(d.currentTarget.offsetWidth<d.currentTarget.scrollWidth)||d.deltaY===0||(d.currentTarget.scrollLeft+=d.deltaY+d.deltaX,d.preventDefault())}const s=ut();return Dt.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:Ht,ssr:s}),Object.assign({selfRef:e,handleWheel:n},{scrollTo(...d){var y;(y=e.value)===null||y===void 0||y.scrollTo(...d)}})},render(){return c("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}});var Nt=/\s/;function Vt(e){for(var n=e.length;n--&&Nt.test(e.charAt(n)););return n}var Xt=/^\s+/;function Ut(e){return e&&e.slice(0,Vt(e)+1).replace(Xt,"")}var Ce=NaN,Gt=/^[-+]0x[0-9a-f]+$/i,Kt=/^0b[01]+$/i,Yt=/^0o[0-7]+$/i,Jt=parseInt;function Re(e){if(typeof e=="number")return e;if(vt(e))return Ce;if(Z(e)){var n=typeof e.valueOf=="function"?e.valueOf():e;e=Z(n)?n+"":n}if(typeof e!="string")return e===0?e:+e;e=Ut(e);var s=Kt.test(e);return s||Yt.test(e)?Jt(e.slice(2),s?2:8):Gt.test(e)?Ce:+e}var le=function(){return ht.Date.now()},qt="Expected a function",Qt=Math.max,Zt=Math.min;function ea(e,n,s){var u,d,y,v,f,x,h=0,g=!1,E=!1,_=!0;if(typeof e!="function")throw new TypeError(qt);n=Re(n)||0,Z(s)&&(g=!!s.leading,E="maxWait"in s,y=E?Qt(Re(s.maxWait)||0,n):y,_="trailing"in s?!!s.trailing:_);function w(b){var R=u,F=d;return u=d=void 0,h=b,v=e.apply(F,R),v}function $(b){return h=b,f=setTimeout(W,n),g?w(b):v}function C(b){var R=b-x,F=b-h,U=n-R;return E?Zt(U,y-F):U}function P(b){var R=b-x,F=b-h;return x===void 0||R>=n||R<0||E&&F>=y}function W(){var b=le();if(P(b))return z(b);f=setTimeout(W,C(b))}function z(b){return f=void 0,_&&u?w(b):(u=d=void 0,v)}function O(){f!==void 0&&clearTimeout(f),h=0,u=x=d=f=void 0}function A(){return f===void 0?v:z(le())}function p(){var b=le(),R=P(b);if(u=arguments,d=this,x=b,R){if(f===void 0)return $(x);if(E)return clearTimeout(f),f=setTimeout(W,n),w(x)}return f===void 0&&(f=setTimeout(W,n)),v}return p.cancel=O,p.flush=A,p}var ta="Expected a function";function aa(e,n,s){var u=!0,d=!0;if(typeof e!="function")throw new TypeError(ta);return Z(s)&&(u="leading"in s?!!s.leading:u,d="trailing"in s?!!s.trailing:d),ea(e,n,{leading:u,maxWait:n,trailing:d})}const fe=gt("n-tabs"),Ee={tab:[String,Number,Object,Function],name:{type:[String,Number],required:!0},disabled:Boolean,displayDirective:{type:String,default:"if"},closable:{type:Boolean,default:void 0},tabProps:Object,label:[String,Number,Object,Function]},da=ee({__TAB_PANE__:!0,name:"TabPane",alias:["TabPanel"],props:Ee,slots:Object,setup(e){const n=Pe(fe,null);return n||xt("tab-pane","`n-tab-pane` must be placed inside `n-tabs`."),{style:n.paneStyleRef,class:n.paneClassRef,mergedClsPrefix:n.mergedClsPrefixRef}},render(){return c("div",{class:[`${this.mergedClsPrefix}-tab-pane`,this.class],style:this.style},this.$slots)}}),ra=Object.assign({internalLeftPadded:Boolean,internalAddable:Boolean,internalCreatedByPane:Boolean},Rt(Ee,["displayDirective"])),be=ee({__TAB__:!0,inheritAttrs:!1,name:"Tab",props:ra,setup(e){const{mergedClsPrefixRef:n,valueRef:s,typeRef:u,closableRef:d,tabStyleRef:y,addTabStyleRef:v,tabClassRef:f,addTabClassRef:x,tabChangeIdRef:h,onBeforeLeaveRef:g,triggerRef:E,handleAdd:_,activateTab:w,handleClose:$}=Pe(fe);return{trigger:E,mergedClosable:Q(()=>{if(e.internalAddable)return!1;const{closable:C}=e;return C===void 0?d.value:C}),style:y,addStyle:v,tabClass:f,addTabClass:x,clsPrefix:n,value:s,type:u,handleClose(C){C.stopPropagation(),!e.disabled&&$(e.name)},activateTab(){if(e.disabled)return;if(e.internalAddable){_();return}const{name:C}=e,P=++h.id;if(C!==s.value){const{value:W}=g;W?Promise.resolve(W(e.name,s.value)).then(z=>{z&&h.id===P&&w(C)}):w(C)}}}},render(){const{internalAddable:e,clsPrefix:n,name:s,disabled:u,label:d,tab:y,value:v,mergedClosable:f,trigger:x,$slots:{default:h}}=this,g=d??y;return c("div",{class:`${n}-tabs-tab-wrapper`},this.internalLeftPadded?c("div",{class:`${n}-tabs-tab-pad`}):null,c("div",Object.assign({key:s,"data-name":s,"data-disabled":u?!0:void 0},mt({class:[`${n}-tabs-tab`,v===s&&`${n}-tabs-tab--active`,u&&`${n}-tabs-tab--disabled`,f&&`${n}-tabs-tab--closable`,e&&`${n}-tabs-tab--addable`,e?this.addTabClass:this.tabClass],onClick:x==="click"?this.activateTab:void 0,onMouseenter:x==="hover"?this.activateTab:void 0,style:e?this.addStyle:this.style},this.internalCreatedByPane?this.tabProps||{}:this.$attrs)),c("span",{class:`${n}-tabs-tab__label`},e?c(yt,null,c("div",{class:`${n}-tabs-tab__height-placeholder`}," "),c(wt,{clsPrefix:n},{default:()=>c(It,null)})):h?h():typeof g=="object"?g:St(g??s)),f&&this.type==="card"?c(Ct,{clsPrefix:n,class:`${n}-tabs-tab__close`,onClick:this.handleClose,disabled:u}):null))}}),na=r("tabs",`
